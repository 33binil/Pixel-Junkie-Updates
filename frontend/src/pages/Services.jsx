...
const Services = ({ showServices = false, translateY = 100 }) => {
    ...
    return (
        <div className={`fixed inset-0 bg-black text-white z-40 transition-all duration-1000 ease-out ${
            ...
            <div className={`h-screen ${translateY <= 0 ? 'overflow-y-auto' : 'overflow-hidden'}`}>
                ...
                <div className="block relative min-h-screen">
                    <div className="flex fixed top-0 md:absolute w-full md:inset-0 justify-center">
                        <div className="flex gap-[5px]">
                            ...
                            <div className={`flex flex-col items-center mt-[37px] md:mt-[80px] transition-all duration-500 delay-300 ${
                                ...
                                <div className="w-[90px] h-[100px] md:w-[300px] md:h-[340px] border border-gray-200 shadow-lg" style={{ backgroundImage: 'url("/B&I.webp")', backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' }}></div>
                            ...
                            <div className={`flex flex-col items-center mt-[100px] md:mt-[286px] transition-all duration-500 delay-400 ${
                                ...
                                <div className="w-[87px] h-[65px] md:w-[290px] md:h-[215px] border border-gray-200 shadow-lg" style={{ backgroundImage: 'url("/uiux.webp")', backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' }}></div>
                            ...
                            <div className={`flex flex-col items-center mt-[70px] md:mt-[192px] transition-all duration-500 delay-500 ${
                                ...
                                <div className="w-[87px] h-[120px] md:w-[290px] md:h-[395px] border border-gray-200 shadow-lg" style={{ backgroundImage: 'url("/wd.webp")', backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' }}></div>
                            ...
                            <div className={`flex flex-col items-center mt-[43px] md:mt-[101px] transition-all duration-500 delay-600 ${
                                ...
                                <div className="w-[87px] h-[100px] md:w-[290px] md:h-[330px] border border-gray-200 shadow-lg" style={{ backgroundImage: 'url("/dm.webp")', backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' }}></div>
                            ...
                            <div className={`hidden md:flex flex-col items-center mt-[308px] transition-all duration-500 delay-700 ${
                                ...
                                <div className="w-[280px] h-[260px] border border-gray-200 shadow-lg" style={{ backgroundImage: 'url("/mg.webp")', backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' }}></div>
                    ...
                    <div className="absolute top-[250px] md:top-[650px] left-1/2 transform -translate-x-1/2 w-full px-10">
                        ...
                        <div className="relative mt-7 md:mt-16 w-full">
                            ...
                            {/* 08 - Motion Graphics */}
                            <div ref={lastServiceRef} className={`sticky top-[400px] md:top-[450px] mb-0 md:mb-[200px] z-[120] flex items-center justify-center gap-8 transition-all duration-700 delay-1400 ${
                                showServices ? 'transform translate-y-0 opacity-100' : 'transform translate-y-[60px] opacity-0'
                            }`}>
                                <div className="hidden md:block">
                                    <div className="bg-black px-10 py-8 rounded-lg">
    ...
    useEffect(() => {
        if (!onEndReached || !lastServiceRef.current) return;
        ...
        observer.observe(lastServiceRef.current);
