                ...
                <div className="w-full max-w-8xl flex flex-col sm:flex-row justify-between items-center sm:items-center gap-16 md:gap-12">
                    ...
                    <div className="flex flex-col items-center sm:items-start text-center sm:text-left">
                        ...
                        <div className="flex gap-[20px] justify-center sm:justify-start">
                            ...
                            <button onClick={() => window.open('https://wa.me/917025133828?text=Hey Pixel Junkie Team! I just visited your website and loved what I saw. I\'d love to discuss how you can help with my branding, design, or digital marketing needs. Let\'s chat!', '_blank')} className="hover:text-[#2ab4bc] transition-colors bg-transparent border-none cursor-pointer">
